...
# Action Selection
echo "==============================================================="
echo " S3PRL Downstream Run Script (ASR, PR, SID, ER) on RTX 3090"
echo "==============================================================="
...
echo "---------------------------------------------------------------"
echo "10) Train Emotion / ER (FiLM-NPC)"
echo "11) Train ER Baseline (Original NPC)"
echo "12) Auto-Resume/Evaluate ER"
echo "==============================================================="
